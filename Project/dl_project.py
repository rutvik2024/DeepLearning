...
!unzip -qq '/content/drive/MyDrive/CustomeImg/monet_jpg.zip' -d '/content/monet_jpg'
!unzip -qq '/content/drive/MyDrive/CustomeImg/photo_jpg.zip' -d '/content/photo_jpg'
!unzip -qq '/content/drive/MyDrive/CustomeImg/monet_tfrec.zip' -d '/content/monet_tfrec'
...
path_monet = '/content/monet_jpg'
path_photo = '/content/photo_jpg'
img_size = 256
